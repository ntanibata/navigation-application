...
HMIMenu {
	...
	function showSurfaces()
	{
		...
		if (Genivi.g_map_handle2) {
			...
			lm_control.surface_set_destination_rectangle(
				2000+Genivi.g_map_handle[1], map.x, map.y, map.width/2, map.height);
			lm_control.surface_set_source_rectangle(
				2000+Genivi.g_map_handle[1], map.x, map.y, map.width/2, map.height);
			lm_control.surface_set_destination_rectangle(
				2000+Genivi.g_map_handle2[1], map.x, map.y, map.width/2, map.height);
			lm_control.surface_set_source_rectangle(
				2000+Genivi.g_map_handle2[1], map.x, map.y, map.width/2, map.height);
			lm_control.surface_set_visibility(2000+Genivi.g_map_handle[1], 1);
			lm_control.surface_set_visibility(2000+Genivi.g_map_handle2[1], 1);
		} else {
	...
	function hideSurfaces()
	{
		...
		if (Genivi.g_map_handle2) {
			...
			lm_control.surface_set_visibility(2000+Genivi.g_map_handle2[1], 0);
		}
